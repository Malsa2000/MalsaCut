...
public class MobileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.fragmentmoblie_fragment, container, false);
        ...
        imageView2.setBackground(getActivity().getDrawable(R.drawable.shap));
        imageView3.setBackground(getActivity().getDrawable(R.drawable.shap_white));
